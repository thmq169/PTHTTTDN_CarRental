...
router.post('/', verifyToken, async (req, res) => {
    const { license_plates, image, type, manufacturer, manufacturer_year,
        ...
        insurance_license, insurance_date, start_day, end_day, name } = req.body
    ...
    try {
        const newCar = new Car({
            ...
            fuel, seat, transmission, start_day, end_day,
            owner_ID: req.userId, name
        })
...
router.get('/:id', verifyToken, async (req, res) => {
    ...
    try {
        ...
        const invoiceOfCar = await Rental_invoice.find({ car_ID: id })
